...
export default function Navbar() {
  ...
  return (
    <div>
      <nav  role="navigation" className="flex items-center bg-black justify-around border mx-4 max-md:w-full max-md:justify-between border-slate-700 px-4  w-full m-0! text-white text-sm">
    <Link href="/">
